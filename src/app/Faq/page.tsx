export default function Faq() {
  ...
  <div className="justify-between items-center p-10">
        <div className="flex flex-row grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* FAQ Card */}
  
              <div className="bg-gray-200 w-auto p-[20px] m-5 rounded-md  shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="bg-gray-200 rounded-md p-[20px] m-5 shadow-md hover:shadow-lg transition-shadow duration-300">
                <h1 className="text-[15px] font-medium flex justify-between items-center">
                  What types of chairs do you offer?
                  <span className="text-2xl font-bold cursor-pointer">+</span>
                </h1>
